...
int main() {
   ...
   /*
    ...
    if(initializeadmins(admins)){
        std::cout << "Admins initialized successfully." << std::endl;
    } else {
        std::cout << "Unable to initialize admins from file." << std::endl;
    }

    if(initializestandardUsers(userss)){
        std::cout << "Standard Users initialized successfully." << std::endl;
    } else {
        std::cout << "Unable to initialize standard users from file." << std::endl;
    }
    ...
    if (loginChoice < 1 || loginChoice > 3) {
        std::cout << "Invalid choice. Please select a valid option (1, 2, or 3)." << std::endl;
        continue; // Go back to the beginning of the loop
    }
...
while (!exitMenu) {
    for (int i = 0; i < userCount; i++) {
        if (managerusername == managers[i].username && managerpassword == managers[i].password) {
            ...
            std::cout <<"15. Show total messages"<<std::endl;
            std::cout << "Enter your choice:";
        ...
        if (messageType.empty() || std::all_of(messageType.begin(), messageType.end(), ::isspace)) {
            std::cout << "Invalid input. Please enter a valid message." << std::endl;
            continue; // Go back to the beginning of the loop
        }
        ...
        continue; // Go back to the beginning of the loop
                ...
                while (true) {
                    ...
                    std::cout << "3. Exit" << std::endl;
                    std::cout << "4. Find flower by ID" << std::endl;
